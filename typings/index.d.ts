...
declare module 'aerospike/policy' {
  export function createPolicy(type: any, values: any): BasePolicy | BatchApplyPolicy | BatchReadPolicy | BatchRemovePolicy | BatchWritePolicy | CommandQueuePolicy | InfoPolicy | HLLPolicy | undefined;
