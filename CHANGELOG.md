...
* **New Features**
  * Support compressed commands and responses. This feature requires Enterprise Server versions >= 4.8. [#312](https://github.com/aerospike/aerospike-client-nodejs/pull/312)
