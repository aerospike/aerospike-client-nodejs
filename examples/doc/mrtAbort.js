...
const MRT_KEYS = ['mrtabort1', 'mrtabort2']
...
async function runExample ({
  ...
  console.info(`MrtAbort aborting transaction with ${keys.length * 2} operations`)
  const status = await client.abort(mrt)
  console.info(`MrtAbort abort status=${status}`)
}

module.exports = { name: 'MrtAbort', runExample, MRT_KEYS }
