...
var ops = aerospike_1.default.operations;
...
var orderList = function (binName, ctx) {
    var setListOrder = lists.setOrder(binName, lists.order.ORDERED);
    if (ctx)
        setListOrder.withContext(ctx);
    return operate(setListOrder);
};
describe('client.operate() - CDT List operations', function () {
    helper.skipUnlessSupportsFeature(aerospike_1.default.features.CDT_LIST, this);
        ...
        context('with nested list context', function () {
            ...
            it('changes the order of a nested list', function () {
                return initState()
                    ...
                    .then(operate([
                    lists.setOrder('list', lists.order.ORDERED).withContext(function (ctx) { return ctx.addListIndex(0); }),
                    lists.setOrder('list', lists.order.ORDERED).withContext(function (ctx) { return ctx.addListIndex(1); }),
                    ops.read('list')
                ]))
        ...
        context('with nested list context', function () {
            ...
            it('sorts a nested list', function () {
                return initState()
                    ...
                    .then(operate([
                    lists.sort('list', lists.sortFlags.DEFAULT).withContext(function (ctx) { return ctx.addListIndex(-1); }),
                    ops.read('list')
                ]))
        ...
        context('with nested list context', function () {
            ...
            it('appends a value to a nested list', function () {
                return initState()
                    ...
                    .then(operate(lists.append('list', 'd').withContext(function (ctx) { return ctx.addListIndex(2); })))
        ...
        context('with nested list context', function () {
            ...
            it('appends the items to a nested list', function () {
                return initState()
                    ...
                    .then(operate(lists.appendItems('map', [99, 100]).withContext(function (ctx) { return ctx.addMapKey('list'); })))
    ...
    describe('lists.insert', function () {
        ...
        context('with insert-bounded flag', function () {
            helper.skipUnlessVersion('>= 4.3.0', this);
            var policy = new aerospike_1.default.ListPolicy({
        ...
        context('with nested list context', function () {
            ...
            it('inserts the item at the specified index of a nested list', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.insert('map', 2, 99).withContext(function (ctx) { return ctx.addMapKey('list'); })))
        ...
        */
        ...
        context('with nested list context', function () {
            ...
            it('inserts the items at the specified index of a nested list', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.insertItems('map', 2, [99, 100]).withContext(function (ctx) { return ctx.addMapKey('list'); })))
                    .then(assertResultEql({ map: 7 }))
        ...
        context('with nested list context', function () {
            ...
            it('removes the item at the specified index and returns it', function () {
                return initState()
                    ...
                    .then(operate(lists.pop('list', 2).withContext(function (ctx) { return ctx.addListIndex(0); })))
                    .then(assertResultEql({ list: 3 }))
    ...
    describe('lists.popRange', function () {
        ...
        context('with nested list context', function () {
            ...
            it('removes the items in the specified range and returns them', function () {
                return initState()
                    .then(createRecord({ list: [[1, 2, 3, 4, 5], [6, 7, 8]] }))
                    .then(operate(lists.popRange('list', 2).withContext(function (ctx) { return ctx.addListIndex(1); })))
    ...
    describe('lists.remove', function () {
        ...
        context('with nested list context', function () {
            ...
            it('removes the item at the specified index', function () {
                return initState()
                    .then(createRecord({ list: [[1, 2, 3, 4, 5], [6, 7, 8]] }))
                    .then(operate(lists.remove('list', 2).withContext(function (ctx) { return ctx.addListIndex(1); })))
                    .then(assertResultEql({ list: 1 }))
                    .then(assertRecordEql({ list: [[1, 2, 3, 4, 5], [6, 7]] }))
                    .then(cleanup);
            });
    ...
    describe('lists.removeRange', function () {
        ...
        context('with nested list context', function () {
            ...
            it('removes the item at the specified range', function () {
                return initState()
                    .then(createRecord({ list: [[1, 2, 3, 4, 5], [6, 7, 8]] }))
                    .then(operate(lists.removeRange('list', 1, 3).withContext(function (ctx) { return ctx.addListIndex(0); })))
                    .then(assertResultEql({ list: 3 }))
    ...
    describe('lists.removeByIndex', function () {
        ...
        context('with nested list context', function () {
            ...
            it('removes the item at the specified index', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.removeByIndex('map', 2).withContext(function (ctx) { return ctx.addMapKey('list'); })))
    ...
    describe('lists.removeByIndexRange', function () {
        ...
        context('with nested list context', function () {
            ...
            it('removes the item int the specified range', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.removeByIndexRange('map', 1, 3).withContext(function (ctx) { return ctx.addMapKey('list'); })))
        ...
        context('with nested list context', function () {
            ...
            it('removes all items with the specified value', function () {
                return initState()
                    ...
                    .then(operate(lists.removeByValue('list', 3).withContext(function (ctx) { return ctx.addListValue([3, 2, 1]); })))
            ...
            context('with nested list context', function () {
                ...
                it('removes all items except with the specified values', function () {
                    return initState()
                        ...
                        .withContext(function (ctx) { return ctx.addListIndex(-1); })
                        .invertSelection()))
    ...
    describe('lists.removeByValueRange', function () {
        ...
        context('with nested list context', function () {
            ...
            it('removes all items in the specified range of values', function () {
                return initState()
                    .then(createRecord({ list: [[1, 2, 3, 4, 5], [6, 7, 8]] }))
                    .then(operate(lists.removeByValueRange('list', 2, 5).withContext(function (ctx) { return ctx.addListIndex(0); })))
                    .then(assertRecordEql({ list: [[1, 5], [6, 7, 8]] }))
                    .then(cleanup);
            });
        });
        ...
        context('with nested list context', function () {
            ...
            it('removes the item with the specified list rank', function () {
                return initState()
                    ...
                    .then(operate(lists.removeByRank('list', 1).withContext(function (ctx) { return ctx.addListIndex(1); })))
        ...
        context('returnType=VALUE', function () {
            it('removes the item with the specified list rank and returns the value', function () {
                return initState()
                    ...
                    .then(assertResultSatisfy(function (result) { return eql(result.list.sort(), [2, 3, 4]); }))
                    .then(assertRecordEql({ list: [1, 5] }))
                    .then(cleanup);
            });
        });
        context('with nested list context', function () {
            ...
            it('removes the item with the specified list rank', function () {
                return initState()
                    ...
                    .then(operate(lists.removeByRankRange('list', 1, 3).withContext(function (ctx) { return ctx.addListIndex(0); })))
    ...
    describe('lists.clear', function () {
        ...
        context('with nested list context', function () {
            ...
            it('removes all elements from the list', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.clear('map').withContext(function (ctx) { return ctx.addMapKey('list'); })))
        ...
        context('with nested list context', function () {
            ...
            it('creates a new list within a map', function () {
                return initState()
                    ...
                    .then(operate(lists.create('map', lists.order.ORDERED).withContext(function (ctx) { return ctx.addMapKeyCreate('nested'); })))
            ...
            it('creates a new list within a list', function () {
                return initState()
                    .then(createRecord({ list: [1, 2, 3, 4, 5] }))
                    .then(operate(lists.create('list', lists.order.UNORDERED, true, false).withContext(function (ctx) { return ctx.addListIndex(10); })))
            ...
            it('creates a new list within a list', function () {
                return initState()
                    .then(createRecord({ list: [1, 2, 3, 4, 5] }))
                    .then(operate(lists.create('list', lists.order.UNORDERED, true, true).withContext(function (ctx) { return ctx.addListIndex(10); })))
                    .then(assertRecordEql({ list: [1, 2, 3, 4, 5, null, null, null, null, null, []] }))
                    .then(cleanup);
            });
        });
    ...
    describe('lists.set', function () {
        ...
        context('with nested list context', function () {
            ...
            it('sets the item at the specified index', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.set('map', 2, 99).withContext(function (ctx) { return ctx.addMapKey('list'); })))
        ...
        context('with nested list context', function () {
            ...
            it('removes all elements not within the specified range', function () {
                return initState()
                    ...
                    .then(operate(lists.trim('list', 1, 3).withContext(function (ctx) { return ctx.addListValue([1, 2, 3, 4, 5]); })))
                    .then(assertResultEql({ list: 2 }))
    ...
    describe('lists.get', function () {
        ...
        context('with nested list context', function () {
            ...
            it('returns the item at the specified index', function () {
                return initState()
                    .then(createRecord({ list: [['a', 'b', 'c'], [1, 2, 3, 4, 5]] }))
                    .then(operate(lists.get('list', 2).withContext(function (ctx) { return ctx.addListIndex(1); })))
                    .then(assertResultEql({ list: 3 }))
                    .then(cleanup);
            });
        });
    ...
    describe('lists.getRange', function () {
        ...
        context('with nested list context', function () {
            ...
            it('returns the items in the specified range', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.getRange('map', 1, 3).withContext(function (ctx) { return ctx.addMapKey('list'); })))
            ...
            context('with nested list context', function () {
                ...
                it('fetches the items in the specified range and returns the values', function () {
                    return initState()
                        ...
                        .withContext(function (ctx) { return ctx.addMapKey('list'); })
                        .andReturn(lists.returnType.VALUE)))
            ...
            context('with nested list context', function () {
                ...
                it('fetches the item with the specified list rank and returns the value', function () {
                    return initState()
                        ...
                        .then(operate(lists
                        .getByRank('list', 1)
                        .withContext(function (ctx) { return ctx.addListIndex(0); })
                        .andReturn(lists.returnType.VALUE)))
                        .then(assertResultEql({ list: 2 }))
                        .then(cleanup);
                });
    ...
    describe('lists.increment', function () {
        ...
        context('with nested list context', function () {
            ...
            it('increments the element at the specified index and returns the final value', function () {
                return initState()
                    .then(createRecord({ map: { list: [1, 2, 3, 4, 5] } }))
                    .then(operate(lists.increment('map', 1, 3).withContext(function (ctx) { return ctx.addMapKey('list'); })))
    ...
    describe('lists.size', function () {
        ...
        context('with nested list context', function () {
            ...
            it('returns the element count', function () {
                return initState()
                    .then(createRecord({ list: [[], [1, 2, 3, 4, 5]] }))
                    .then(operate(lists.size('list').withContext(function (ctx) { return ctx.addListIndex(-1); })))
                    .then(assertResultEql({ list: 5 }))
                    .then(cleanup);
            });
        });
    ...
    describe('ListOperation', function () {
        describe('#invertSelection', function () {
            it('throws an error if the operation is not invertible', function () {
                ...
                (0, chai_1.expect)(function () { return op.invertSelection(); }).to.throw(AerospikeError, 'List operation cannot be inverted');
            });
        });
    });
});
