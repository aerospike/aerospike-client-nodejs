...
context('registering/unregistering UDF modules', function () {
  ...
  it('should register and then remove a module', function (done) {
    client.udfRegister(filename, function (err?: AerospikeError, registerJob?: Job) {
      if (err) throw err
      registerJob?.wait(10, function (err?: AerospikeError) {
        if (err) throw err
        client.udfRemove(module, function (err?: AerospikeError, removeJob?: Job) {
          if (err) throw err
  ...
  it('should register a module as Lua language', function (done) {
    client.udfRegister(filename, Aerospike.language.LUA, function (err?: AerospikeError, registerJob?: Job) {
      if (err) throw err
      registerJob?.wait(10, function (err?: AerospikeError) {
        if (err) throw err
        client.udfRemove(module, function (err?: AerospikeError, removeJob?: Job) {
  ...
  it('should register a module with an info policy', function (done) {
    ...
    client.udfRegister(filename, policy, function (err?: AerospikeError, registerJob?: Job) {
      if (err) throw err
      registerJob?.wait(10, function (err?: AerospikeError) {
        if (err) throw err
        client.udfRemove(module, function (err?: AerospikeError, removeJob?: Job) {
  ...
  it('should register a module as Lua language with an info policy', function (done) {
    ...
    client.udfRegister(filename, Aerospike.language.LUA, policy, function (err?: AerospikeError, registerJob?: Job) {
      if (err) throw err
      registerJob?.wait(10, function (err?: AerospikeError) {
        if (err) throw err
        client.udfRemove(module, function (err?: AerospikeError, removeJob?: Job) {
  ...
  context('error handling', function () {
    it('should fail to register an non-existent module', function (done) {
      client.udfRegister('no-such-udf.lua', function (err?: AerospikeError) {
    ...
    it('should fail to register module with invalid language', function (done) {
      client.udfRegister(filename, -99, function (err?: AerospikeError) {
    ...
    context('removing a non-existent module', function () {
      context('server version 4.5.1 and later', function () {
        ...
        it('should not fail when removing a non-existent module', function () {
          return client.udfRemove('no-such-udf.lua').then((job: Job) => job.waitUntilDone())
        })
      })
      ...
      context('server version 4.5.0 and earlier', function () {
        ...
        it('should return an error when removing a non-existent module', function (done) {
          client.udfRemove('no-such-udf.lua', function (error?: AerospikeError) {
