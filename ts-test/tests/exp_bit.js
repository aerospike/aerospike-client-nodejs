...
describe('Aerospike.exp_operations', function () {
    ...
    describe('bit expressions', function () {
        describe('bit bin get expression', function () {
            it('evaluates exp_read op to true if temp bin equals to bin bits', function () {
                return __awaiter(this, void 0, void 0, function () {
                    var key, ops, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, createRecord({ blob: Buffer.from([0, 1, 2, 3]) })];
                            case 1:
                                key = _a.sent();
                                ops = [
                                    exp.operations.read(tempBin, exp.bit.count(exp.binBlob('blob'), exp.uint(32), exp.int(0)), // b0,b1,b10,b11 (4bits set)
