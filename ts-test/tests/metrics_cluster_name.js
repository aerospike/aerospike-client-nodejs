...
describe('Test metrics cluster name', function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function disableListener(cluster) {
            ...
            (0, chai_1.expect)(cluster.clusterName).to.eql("pass_test");
            return;
        }
        var snapshotTriggered, disableTriggered;
        return __generator(this, function (_a) {
            //const client: Cli = helper.client
            helper.skipUnlessAdvancedMetrics(this);
            snapshotTriggered = false;
            disableTriggered = false;
            it('Test metrics cluster name retrival', function () {
                return __awaiter(this, void 0, void 0, function () {
                    var SERVER_PORT_NUMBER, container, containers, config, dummyClient, listeners, policy;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 9:
                                _a.sent();
                                (0, chai_1.expect)(disableTriggered).to.eql(false);
