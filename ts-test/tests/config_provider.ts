...
describe('MRT API Tests', function () {
  ...
  context('Test the MRT specific API', function () { 
    ...
    context('Dynamic config should take precedence over the programatic config', function () { 
      it('Uses the AEROSPIKE_CLIENT_CONFIG_URL enviornment variable', async function () {
      ...
      it('AEROSPIKE_CLIENT_CONFIG_URL takes precedence over', async function () {
    ...
    it('enableMetrics does not override the dynamic config', async function () {
    ...
    it('disable does not override the dynamic config', async function () {
