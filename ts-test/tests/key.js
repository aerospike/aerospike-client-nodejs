...
describe('Key #noserver', function () {
        ...
        */
        context('set name', function () {
            it('allows null set name', function () {
                (0, chai_1.expect)(new Key('ns', null, 'key')).to.be.ok;
            });
            it('allows undefined set name', function () {
                (0, chai_1.expect)(new Key('ns', undefined, 'key')).to.be.ok;
            });
            /*
        ...
        context('user key', function () {
            ...
            it('allows string user key', function () {
                (0, chai_1.expect)(new Key('ns', 'set', 'abc')).to.be.ok;
            });
            it('allows string user key of arbitrary length', function () {
                (0, chai_1.expect)(new Key('ns', 'set', 'abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789')).to.be.ok;
            });
            it('allows integer user key', function () {
                (0, chai_1.expect)(new Key('ns', 'set', 1234)).to.be.ok;
                (0, chai_1.expect)(new Key('ns', 'set', -1234)).to.be.ok;
            });
            context('BigInt keys', function () {
                it('allows BigInt user key', function () {
                    (0, chai_1.expect)(new Key('ns', 'set', BigInt(42))).to.be.ok;
                    (0, chai_1.expect)(new Key('ns', 'set', Math.pow(BigInt(2), BigInt(63)) - BigInt(1))).to.be.ok;
                    (0, chai_1.expect)(new Key('ns', 'set', Math.pow(BigInt(-2), BigInt(63)))).to.be.ok;
                });
                /*
            ...
            it('allows byte array user key', function () {
                ...
                (0, chai_1.expect)(new Key('ns', 'set', buf)).to.be.ok;
            });
            it('allows undefined user key', function () {
                (0, chai_1.expect)(new Key('ns', 'set', undefined, dummyDigest)).to.be.ok;
            });
            it('allows null user key', function () {
                (0, chai_1.expect)(new Key('ns', 'set', null, dummyDigest)).to.be.ok;
            });
            /*
        ...
        context('digest', function () {
            it('allows creating a new key with just the namespace and digest', function () {
                ...
                (0, chai_1.expect)(new Key('ns', null, null, digest)).to.be.ok;
            });
            /*
    ...
    describe('equals', function () {
        it('matches two keys with identical ns, set and user key', function () {
            ...
            (0, chai_1.expect)(key1.equals(key2)).to.be.true;
            (0, chai_1.expect)(key2.equals(key1)).to.be.true;
        });
        ...
        it('does not match two keys with different ns', function () {
            ...
            (0, chai_1.expect)(key1.equals(key2)).to.be.false;
            (0, chai_1.expect)(key2.equals(key1)).to.be.false;
        });
...
context('Plain Object Keys (for backward compatibility)', function () {
    ...
    it('returns an error for an invalid user key', function (done) {
      ...
      client.put(key, { foo: 'bar' }, function (err: any) {
