...
class BasePolicy {
  ...
  constructor (props) {
     ...
     * and <code>timeout</code> are checked. If <code>maxRetries</code>
     * and <code>timeout</code> are not exceeded, the transaction is
     * retried.
     *
     * If both <code>socketTimeout</code> and <code>timeout</code> are
     * non-zero and <code>socketTimeout</code> > <code>timeout</code>,
     * then <code>socketTimeout</code> will be set to
     * <code>timeout</code>. If <code>socketTimeout</code> is zero, there
     ...
     *
     * The <code>timeout</code> is tracked on the client and sent to the
     ...
     *
     * If <code>timeout</code> is not zero and <code>timeout</code>
     ...
     * If <code>timeout</code> is zero, there will be no total time limit.
     *
     * @type number
     * @default 1000
     */
