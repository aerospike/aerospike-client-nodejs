 ...
 * values that are supported by all client policies, including totalTimeout and
 * retry handling.
 *
 * @since v3.0.0
 */
class BasePolicy {
  ...
  constructor (props) {
    ...
    /**
     * Total transaction totalTimeout in milliseconds.
     *
     ...
     * most likely totalTimeout first, but the server also has the capability to
     * totalTimeout the transaction.
     *
