  ...
  if (typeof callback === 'function') {
    this.sendCommand('indexCreate', args, error => {
      if (error) {
        ...
        return callback(null, new IndexJob(this, options.ns, options.index))
      }
    })
  } else {
  ...
  if (typeof callback === 'function') {
    this.sendCommand('udfRegister', [udfPath, udfType, policy], error => {
      if (error) {
        ...
        return callback(null, new UdfJob(this, module, UdfJob.REGISTER))
      }
    })
  } else {
  ...
  if (typeof callback === 'function') {
    this.sendCommand('udfRemove', [udfModule, policy], error => {
      if (error) {
        ...
        return callback(null, new UdfJob(this, udfModule, UdfJob.UNREGISTER))
      }
    })
  } else {
