 ...
 * the index to be created, e.g. Numeric, String or Geo.  @param
 * {Client~InfoPolicy} [policy] - The Info Policy to use for this operation.
 ...
 *
 * @param {?AerospikeError} error - The error code and message or <code>null</code> if the operation was successful.
 * @param {(IndexTask)} [task] - Handle on a potentially long-running task which can be used to check for task completion.
 */
