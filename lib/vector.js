 ...
 *
 * Note: the server does not yet implement vector distance expressions
 * ({@link module:aerospike/exp.vector}) or the vector index / ANN search
 * commands - only plain get/put of <code>Vector</code> bin values is
