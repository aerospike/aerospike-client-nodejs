...
// Server-enforced payload cap: 256KB.
 ...
 * vector similarity search (see {@link module:aerospike/exp.vector}).
 *
 ...
 * constructor.
 *
 * <code>Vector</code> bin values are sent to/received from the server as an
 * <code>as_bytes</code> value tagged <code>AS_BYTES_VECTOR</code>
 * (analogous to how {@link HyperLogLog} values are tagged
 * <code>AS_BYTES_HLL</code>). This class can also be constructed, validated,
 * and serialized to/from its wire-format {@link Buffer} representation
...
class Vector {
  ...
  static fromBuffer (buffer) {
    ...
    // Bytes [6, 8) are reserved and not currently validated.
   ...
   * float&harr;half-float value conversion.
   *
 ...
 * {@link Vector} is encoded on the wire.
 *
 * @type {Object}
