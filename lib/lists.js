...
exports.removeByIndexRange = function (bin, index, count, returnType) {
  return new ListOperation(opcodes.LIST_REMOVE_BY_INDEX_RANGE, bin, {
    index: index,
    count: count,
    returnType: returnType
  })
...
exports.removeByValue = function (bin, value, returnType) {
  return new ListOperation(opcodes.LIST_REMOVE_BY_VALUE, bin, {
    value: value,
    returnType: returnType
  })
}
...
exports.removeByValueList = function (bin, values, returnType) {
  return new ListOperation(opcodes.LIST_REMOVE_BY_VALUE_LIST, bin, {
    values: values,
    returnType: returnType
  })
}
...
exports.removeByValueRange = function (bin, begin, end, returnType) {
  return new ListOperation(opcodes.LIST_REMOVE_BY_VALUE_RANGE, bin, {
    begin: begin,
    end: end,
    returnType: returnType
  })
...
exports.removeByRankRange = function (bin, rank, count, returnType) {
  return new ListOperation(opcodes.LIST_REMOVE_BY_RANK_RANGE, bin, {
    rank: rank,
    count: count,
    returnType: returnType
  })
