...
exports.setOrder = function (bin, order) {
  var op = new ListOperation(opcodes.LIST_SET_ORDER, bin)
  op.order = order
  return op
}

exports.sort = function (bin, flags) {
  var op = new ListOperation(opcodes.LIST_SORT, bin)
  op.flags = flags
  return op
}
 ...
 * })
 */
exports.appendItems = function (bin, list) {
 ...
 * })
 */
exports.insert = function (bin, index, value) {
 ...
 * })
 */
exports.insertItems = function (bin, index, list) {
 ...
 * })
 */
exports.increment = function (bin, index, value) {
