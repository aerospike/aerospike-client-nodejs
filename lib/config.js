...
class Config {
  ...
  constructor (config) {
     ...
     * @property {string} [keyfile] - TODO
     * @property {string} [keyfilePassword] - TODO
     * @property {string} [certfile] - TODO
     ...
     * @property {boolean} [logSessionInfo] - TODO
     * @property {boolean} [forLoginOnly] - TODO
     *
     */
