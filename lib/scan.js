...
Scan.prototype.background = function (udfModule, udfFunction, udfArgs, policy, scanID, callback) {
  ...
  if (typeof callback === 'function') {
    this.client.sendCommand('scanBackground', [this.ns, this.set, this, policy, scanID], error => {
      if (error) {
        callback(error)
      } else {
        callback(null, new Job(this.client, scanID, 'scan'))
      }
    })
  } else {
    return this.client.sendCommandAsync('scanBackground', [this.ns, this.set, this, policy, scanID],
      () => new Job(this.client, scanID, 'scan'))
  }
}
...
Scan.prototype.foreach = function (policy, dataCb, errorCb, endCb) {
  ...
  var scanCb = function (error, bins, meta, key) {
    if (error) {
