 ...
 * through the stream.
 *
 * Standard secondary index queries are supported. A stream UDF can be applied
 * to the query using the {@link Query#setUdf} method before query execution.
 * For aggregation queries that return a single result instead of a record
 * stream you should use the {@link Query#apply} method instead.
 *
