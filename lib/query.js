 ...
 * the query.
 *
 * @param {FilterPredicate | Predicate[]} predicate - The filter predicate to apply to the function.
 *
...
Query.prototype.where = function (predicate) {
  if (Array.isArray(predicate) && predicate[0] instanceof predexp.Predicate) {
    this.predexp = predicate
  } else {
 ...
 *
 * @description This method returns a Promis that contains the query results
