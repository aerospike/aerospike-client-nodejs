...
class BitwiseOperation {
  ...
  /**
   * @summary Applies a policy to the operation.
   *
 ...
 *
 * Bitwise operation variant that can overflow.
 */
 ...
 *
 * @description Action to take when bitwise add/subtract results in
 * overflow/underflow.
 *
 * @type Object
 ...
 * @param {number} [flags] - Optional {@link module:aerospike/bitwise.resizeFlags|resize flags}.
 ...
 * @description Server inserts value bytes into bitmap at offset
 * <code>offset</code>.  Server does not return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 ...
 * @description Server removes <code>byteSize</code> bytes from bitmap at
 * offset <code>byteOffset</code>.  Server does not return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 ...
 * @description Server sets value on bitmap at offset <code>bitOffset</code>
 * for <code>bitSize</code> bits. Server does not return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 ...
 * @description Server performs bitwise "or" on value and bitmap at offset
 * <code>bitOffset</code> for <code>bitSize</code> bits. Server does not
 * return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 * @param {number} bitOffset - Offset in bits.
 ...
 * @description Server performs bitwise "xor" on value and bitmap at offset
 * <code>bitOffset</code> for <code>bitSize</code> bits. Server does not
 * return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 ...
 * @description Server performs bitwise "and" on value and bitmap at offset
 * <code>bitOffset</code> for <code>bitSize</code> bits. Server does not
 * return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 ...
 * @description Server negates bitmap at offset <code>bitOffset</code> for
 * <code>bitSize</code> bits. Server does not return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 * @param {number} bitOffset - Offset in bits.
 * @param {number} bitSize - Number of bits.
 ...
 * @description Server shifts left bitmap starting at offset
 * <code>bitOffset</code> for <code>bitSize</code> bits. Server does not return
 * a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 * @param {number} bitOffset - Offset in bits.
 ...
 * @description Server shifts right bitmap starting at offset
 * <code>bitOffset</code> for <code>bitSize</code> bits. Server does not return
 * a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 ...
 * @description Server adds value to bitmap.
 * Server does not return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 * @param {number} bitOffset - Offset in bits.
 ...
 *
 * @see {@link
 * module:aerospike/bitwise~OverflowableBitwiseOp#onOverflow|onOverflow} can
 * used to control how the operation executes, when the addition results in an
 * overflow/underflow.
 */
 ...
 * @description Server subtracts value from bitmap.
 * Server does not return a value.
 *
 * @param {string} bin - The name of the bin. The bin must contain a byte value.
 * @param {number} bitOffset - Offset in bits.
 ...
 * @see {@link
 * module:aerospike/bitwise~OverflowableBitwiseOp#onOverflow|onOverflow} can
 * used to control how the operation executes, when the subtraction results in
