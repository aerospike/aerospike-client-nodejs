...
/**
 * @summary Path select expression.
 ...
 *
 */
exports.selectByPath = function (bin, flags, ctx) {
...
/**
 * @summary Path modify expression.
 * Used in path expressions.
 *
 * @param {string} bin - The name of the bin.
 * @param {AerospikeExp} modExp - expression for modification.
 * @param {exp.pathModifyFlags} flags - path modify flags.
 * @param {cdt.Context} ctx - CDT context.
 * @returns {Operation} Operation that can be passed to the {@link Client#operate} command.
 *
 */
exports.modifyByPath = function (bin, modExp, flags, ctx) {
  if (!(ctx instanceof cdtContext)) {
    throw new TypeError('ctx must be a CDT Context')
  }
