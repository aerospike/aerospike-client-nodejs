...
let ApplyPolicy = require('./policy/apply_policy')
let BatchPolicy = require('./policy/batch_policy')
let InfoPolicy = require('./policy/info_policy')
let OperatePolicy = require('./policy/operate_policy')
let QueryPolicy = require('./policy/query_policy')
let ReadPolicy = require('./policy/read_policy')
let RemovePolicy = require('./policy/remove_policy')
let ScanPolicy = require('./policy/scan_policy')
let WritePolicy = require('./policy/write_policy')
