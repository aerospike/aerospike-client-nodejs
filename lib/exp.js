...
exports.to_int = _p2Exp(exp.ops.TO_INT)
exports.to_float = _p2Exp(exp.ops.TO_FLOAT)

exports.int_and = _VAargs(exp.ops.INT_AND)
exports.int_or = _VAargs(exp.ops.INT_OR)
exports.int_xor = _VAargs(exp.ops.INT_XOR)

exports.int_not = _p2Exp(exp.ops.INT_NOT)

exports.int_lshift = _p3Exp(exp.ops.INT_LSHIFT)
exports.int_rshift = _p3Exp(exp.ops.INT_RSHIFT)
exports.int_arshift = _p3Exp(exp.ops.INT_ARSHIFT)

exports.int_count = _p2Exp(exp.ops.INT_COUNT)

exports.int_lscan = _p3Exp(exp.ops.INT_LSCAN)
exports.int_rscan = _p3Exp(exp.ops.INT_RSCAN)
...
/*********************************************************************************
 * LIST READ and MODIFY EXPRESSIONS
 *********************************************************************************/
...
exports.lists = {
  ...
  append_items: (bin, val, policy = null, ctx = null) => [
  ...
  insert_items: (bin, val, idx, policy = null, ctx = null) => [
  ...
  remove_all_by_value: (bin, val, ctx = null) => [
  ...
  remove_by_value_list: (bin, values, ctx = null) => [
  ...
  remove_by_value_range: (bin, end, begin, ctx = null) => [
  ...
  remove_by_rel_rank_range_to_end: (bin, rank, val, ctx = null) => [
  ...
  remove_by_rel_rank_range: (bin, count, rank, val, ctx = null) => [
  ...
  remove_by_index: (bin, idx, ctx = null) => [
  ...
  remove_by_index_range_to_end: (bin, idx, ctx = null) => [
  ...
  remove_by_index_range: (bin, count, idx, ctx = null) => [
  ...
  remove_by_rank: (bin, rank, ctx = null) => [
  ...
  remove_by_rank_range_to_end: (bin, rank, ctx = null) => [
  ...
  remove_by_rank_range: (bin, count, rank, ctx = null) => [
...
/*********************************************************************************
 * MAP READ and MODIFY EXPRESSIONS
 *********************************************************************************/
...
exports.maps = {
  ...
  put_items: (bin, map, policy = null, ctx = null) => [
  ...
  remove_by_key: (bin, key, ctx = null) => [
  ...
  remove_by_key_list: (bin, keys, ctx = null) => [
  ...
  remove_by_key_range: (bin, end, begin, ctx = null) => [
  ...
  remove_by_key_rel_index_range_to_end: (bin, idx, key, ctx = null) => [
  ...
  remove_by_key_rel_index_range: (bin, count, idx, key, ctx = null) => [
  ...
  remove_by_value: (bin, val, ctx = null) => [
  ...
  remove_by_value_rel_rank_range_to_end: (bin, rank, val, ctx = null) => [
   ...
   remove_by_value_rel_rank_range: (bin, count, rank, val, key, ctx = null) => [
