...
const _valueExpBytes = (op, valName, sizeName) => (val, size) => [{ op, [valName]: val, [sizeName]: size }]
 ...
 *********************************************************************************/
  ...
  getByKeyRelIndexRange: (bin, count, idx, key, rtype, ctx = null) => [
    ..._mapRead(exp.type.AUTO, rtype, true),
...
exports.bit = {
  ...
  reSize: (bin, flags, byteSize, policy = null) => [
    ..._bitModStart(exp.ops.BIT_RESIZE, 3),
    ...byteSize,
  ...
  insert: (bin, val, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_INSERT, 3),
    ...byteOffset,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
    ...bin
  ...
  remove: (bin, byteSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_REMOVE, 3),
    ...byteOffset,
    ...byteSize,
    ..._uint((policy ? policy.flags : 0)),
    ...bin
  ...
  set: (bin, val, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_SET, 4),
    ...byteOffset,
    ...bitSize,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
  ...
  or: (bin, val, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_OR, 4),
    ...byteOffset,
    ...bitSize,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
  ...
  xor: (bin, val, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_XOR, 4),
    ...byteOffset,
    ...bitSize,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
  ...
  and: (bin, val, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_AND, 4),
    ...byteOffset,
    ...bitSize,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
  ...
  not: (bin, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_NOT, 3),
    ...byteOffset,
    ...bitSize,
    ..._uint((policy ? policy.flags : 0)),
    ...bin
  ...
  lShift: (bin, shift, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_LSHIFT, 4),
    ...byteOffset,
    ...bitSize,
    ...shift,
    ..._uint((policy ? policy.flags : 0)),
  ...
  rShift: (bin, shift, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_RSHIFT, 4),
    ...byteOffset,
    ...bitSize,
    ...shift,
    ..._uint((policy ? policy.flags : 0)),
  ...
  add: (bin, action, val, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_ADD, 5),
    ...byteOffset,
    ...bitSize,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
  ...
  subtract: (bin, action, val, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_SUBTRACT, 5),
    ...byteOffset,
    ...bitSize,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
  ...
  setInt: (bin, val, bitSize, byteOffset, policy = null) => [
    ..._bitModStart(exp.ops.BIT_SET_INT, 4),
    ...byteOffset,
    ...bitSize,
    ...val,
    ..._uint((policy ? policy.flags : 0)),
 ...
 *********************************************************************************/
  ...
  lScan: (bin, val, bitSize, byteOffset) => [
  ...
  rScan: (bin, val, bitSize, byteOffset) => [
  ...
  getInt: (bin, sign, bitSize, byteOffset) => [
