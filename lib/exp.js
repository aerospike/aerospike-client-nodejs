 ...
 *
 * @remarks The native binding exposes {@link exp.ops.IS_TOMBSTONE} as Aerospike
 * `_AS_EXP_CODE_IS_TOMBSTONE` only. A mistaken duplicate registration mapping the
 * same name to `NOT` would invert semantics; use {@link exp.not} for logical NOT.
 *
 * @function
