...
// TODO: Add list & map value expressions
...
exports.lists = {
  // TODO: Make ctx and/or returnType optional params?
  size: (ctx, bin) => [
  ...
  getByValue: (ctx, returnType, value, bin) => [
  ...
  getByValueRange: (ctx, returnType, begin, end, bin) => [
    ..._listRead(exp.type.AUTO, returnType, true),
  ...
  getByValueList: (ctx, returnType, value, bin) => [
    ..._listRead(exp.type.AUTO, returnType, true),
