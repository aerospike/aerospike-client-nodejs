 ...
 * determine whether a new map will be created automatically if the record
 * bin, which the map operation is targeting, is currently empty.
 *
 * Map write flags require server version v4.3 or later. For earier server versions,
 * set the {@link module:aerospike/maps.writeMode|writeMode} instead.
 *
 * @type Object
