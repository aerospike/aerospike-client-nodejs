...
/**
 * @summary Enumeration of secondary index (SI) data types.
 *
 * @readonly
 * @enum {number}
 *
 * @property {number} STRING - Values contained in the secondary index (SI) are strings.
 * @property {number} NUMERIC - Values contained in the secondary index (SI) are integers.
 * @property {number} GEO2DSPHERE - Values contained in the secondary index (SI) are GeoJSON values (points or polygons).
 *
...
/**
 * @summary Enumeration of secondary index (SI) types.
 *
 * @readonly
 * @enum {number}
 *
 * @property {number} DEFAULT - Default secondary index (SI) type for bins
 * containing scalar values (i.e. integer, string).
 * @property {number} LIST - Secondary index (SI) for bins containing
 ...
 * @property {number} MAPKEYS - Secondary index (SI) for bins containing
 ...
 * @property {number} MAPVALUES - Secondary index (SI) for bins containing
 * <a href="http://www.aerospike.com/docs/guide/cdt-map.html" title="Aerospike Maps Data Type">&uArr;Maps</a>;
