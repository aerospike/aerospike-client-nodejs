...
aerospike.operator = {
	...
	prepend: prepend_op,
	touch: touch_op,
	list_append: list_append_op,
	list_append_items: list_append_items_op,
	list_insert: list_insert_op,
	list_insert_items: list_insert_items_op,
	list_pop: list_pop_op,
	list_pop_range: list_pop_range_op,
	list_remove: list_remove_op,
	list_remove_range: list_remove_range_op,
	list_clear: list_clear_op,
	list_set: list_set_op,
	list_trim: list_trim_op,
	list_get: list_get_op,
	list_get_range: list_get_range_op,
	list_size: list_size_op
};
