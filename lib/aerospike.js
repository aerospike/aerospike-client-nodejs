 ...
 */
const bitwise = exports.bitwise = require('./bitwise')
// copy bitwise related enums into bitwise module
Object.keys(as.bitwise).forEach(key => {
  bitwise[key] = as.bitwise[key]
})
