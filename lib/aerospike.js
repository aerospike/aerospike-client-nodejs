...
function Aerospike () {
  ...
  /**
   * @member {Object} scanStatus
   * @readonly
   * @static
   *
   * @description Enumeration of scan status codes.
   *
   * @see {@link ScanTask#infoCallback} returns the scan status.
   *
   * @property {number} UNDEF - The scan status is undefined. This is likely due to the status not being properly checked.
   *
   * @property {number} INPROGRESS - The scan is currently running.
   *
   * @property {number} ABORTED - The scan was aborted; due to failure or the user.
   *
   * @property {number} COMPLETED - The scan completed successfully.
   */
