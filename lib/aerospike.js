 ...
 *
 * Note: as of this writing, sending/receiving {@link Vector} values to/from
 * the Aerospike server is not yet implemented in this client - see
 * `docs/design/vector-phase-1-client-design.md` in this repository.
 *
