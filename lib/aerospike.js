 ...
 * operations for {@link Client#operate} (server 8.2.0+).
 *
 ...
 * @property {number} INTEGER - For use with server versions 8.2.0+. The Aerospike C client
 * maps this to <code>NUMERIC</code> on older servers.
 * @property {number} NUMERIC - <b>Deprecated.</b> For use with server versions prior to 8.2.0.
 * Use {@link module:aerospike.indexDataType.INTEGER} for server 8.2.0+. The C client maps this
 * to <code>INTEGER</code> on server 8.2.0+.
