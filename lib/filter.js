 ...
 * @classdesc Secondary index (SI) filter predicate to limit the scope of a {@link Query}.
 *
 ...
 * @returns {module:aerospike/filter~SindexFilterPredicate} Secondary index (SI)
