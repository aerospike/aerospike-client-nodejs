...
#define TYPE_CHECK_REQ(val, type, msg)                                         \
	if (!val->type())                                                          \
	return Nan::ThrowTypeError(msg)
#define TYPE_CHECK_OPT(val, type, msg)                                         \
	if (!(val->IsNull() || val->IsUndefined() || val->type()))                 \
	return Nan::ThrowTypeError(msg)
...
class AerospikeClient : public Nan::ObjectWrap {
  ...
  private:
	...
	static NAN_METHOD(PrivilegeGrant);
	static NAN_METHOD(PrivilegeRevoke);
	...
	static NAN_METHOD(QueryPages);
	static NAN_METHOD(QueryRole);
	static NAN_METHOD(QueryRoles);
	static NAN_METHOD(QueryUser);
	static NAN_METHOD(QueryUsers);
	static NAN_METHOD(Register);
	static NAN_METHOD(RemoveAsync);
	static NAN_METHOD(RemoveSeedHost);
	static NAN_METHOD(RoleCreate);
	static NAN_METHOD(RoleDrop);
	static NAN_METHOD(RoleGrant);
	static NAN_METHOD(RoleRevoke);
	static NAN_METHOD(RoleSetWhitelist);
	static NAN_METHOD(RoleSetQuotas);
	...
	static NAN_METHOD(UserCreate);
	static NAN_METHOD(UserCreatePKI);
	static NAN_METHOD(UserDrop);
