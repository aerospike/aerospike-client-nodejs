...
int add_list_op(as_operations* ops, int64_t opcode, v8::Local<v8::Object> op, LogInfo* log);
int add_map_op(as_operations* ops, int64_t opcode, v8::Local<v8::Object> op, LogInfo* log);
