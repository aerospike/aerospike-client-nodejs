...
Local<Object> status()
{
	...
	set(obj, "AEROSPIKE_METRICS_CONFLICT", AEROSPIKE_METRICS_CONFLICT);
	...
	set(obj, "AEROSPIKE_MRT_BLOCKED", AEROSPIKE_MRT_BLOCKED);
	...
	set(obj, "AEROSPIKE_EXPIRED_SESSION", AEROSPIKE_EXPIRED_SESSION);
	...
	set(obj, "AEROSPIKE_INVALID_WHITELIST", AEROSPIKE_INVALID_WHITELIST);
	set(obj, "AEROSPIKE_QUOTAS_NOT_ENABLED", AEROSPIKE_QUOTAS_NOT_ENABLED);
