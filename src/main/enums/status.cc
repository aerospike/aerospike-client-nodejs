...
Local<Object> status()
{
	...
	set(obj, "AEROSPIKE_ERR_FAIL_ELEMENT_NOT_FOUND", 23); // TODO: replace with C client enum
	set(obj, "AEROSPIKE_ERR_FAIL_ELEMENT_EXISTS", 24); // TODO: replace with C client enum
