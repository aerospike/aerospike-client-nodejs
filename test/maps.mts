...
const orderMap = (binName: string, order?: Maps.order, ctx?: cdt.Context) => {
  ...
  const setMapPolicy = maps.setPolicy(binName, policy)
  if (ctx) setMapPolicy.withContext(ctx)
  return operate(setMapPolicy)
}
const orderByKey = (binName: string, ctx?: cdt.Context) => orderMap(binName, maps.order.KEY_ORDERED, ctx)
const orderByKeyValue = (binName: string, ctx?: cdt.Context) => orderMap(binName, maps.order.KEY_VALUE_ORDERED, ctx)
  ...
  describe('maps.create', function () {
    ...
    it('Creates a new map from a cdt context', function () {
      return initState()
        .then(createRecord({ map: { c: 1, b: 2, a: 3 } }))
        .then(orderByKey('map'))
        .then(operate(maps.create('map', maps.order.KEY_ORDERED).withContext((ctx: cdt.Context) => ctx.addMapKeyCreate('nested'))))
    ...
    context('with nested map context', function () {
      ...
      it('adds the item to the nested map', function () {
        return initState()
          ...
          .then(operate(maps.put('list', 'd', 99).withContext((ctx: cdt.Context) => ctx.addListIndex(0))))
    ...
    context('with nested map context', function () {
      ...
      it('adds each item to the nested map', function () {
        return initState()
          ...
          .then(operate(maps.putItems('map', { c: 99, d: 100 }).withContext((ctx: cdt.Context) => ctx.addMapKey('nested'))))
          .then(assertResultEql({ map: 4 }))
    ...
    context('with nested map context', function () {
      ...
      it('increments the value of the entry and returns the final value', function () {
        return initState()
          ...
          .then(operate(maps.increment('list', 'b', 10).withContext((ctx: cdt.Context) => ctx.addListIndex(1))))
    ...
    context('with nested map context', function () {
      ...
      it('decrements the value of the entry and returns the final value', function () {
        return initState()
          ...
          .then(operate(maps.decrement('list', 'b', 10).withContext((ctx: cdt.Context) => ctx.addListIndex(0))))
      ...
      it('removes all entries from the map', function () {
        return initState()
          ...
          .then(operate(
            maps
              .clear('map')
              .withContext((ctx: cdt.Context) => ctx.addMapKey('nested').addMapKey('deepNested'))
          ))
    ...
    context('with nested map context', function () {
      ...
      it('removes a map entry identified by key', function () {
        return initState()
          ...
          .then(operate(maps.removeByKey('list', 'b').withContext((ctx: cdt.Context) => ctx.addListIndex(-1))))
    ...
    context('with nested map context', function () {
      ...
      it('removes map entries identified by one or more keys', function () {
        return initState()
          ...
          .then(operate(maps.removeByKeyList('maps', ['a', 'c']).withContext((ctx: cdt.Context) => ctx.addMapKey('a'))))
        ...
        return initState()
          ...
          .then(operate(
            maps
              ...
              .withContext((ctx: cdt.Context) => ctx.addListValue({ a: 1, b: 2 })) // matches only the first list value
    ...
    context('with nested map context', function () {
      ...
      it('removes map entries identified by one or more values', function () {
        return initState()
          ...
          .then(operate(maps.removeByValueList('map', [1, 3]).withContext((ctx: cdt.Context) => ctx.addMapKey('a'))))
    ...
    context('with nested map context', function () {
      ...
      it('removes map entries identified by value range', function () {
        return initState()
          ...
          .then(operate(maps.removeByValueRange('list', 2, 3).withContext((ctx: cdt.Context) => ctx.addListIndex(-1))))
  ...
  describe('maps.removeByIndex', function () {
    ...
    context('with nested map context', function () {
      ...
      it('removes a map entry identified by index', function () {
        return initState()
          .then(createRecord({ map: { nested: { a: 1, b: 2, c: 3 } } }))
          .then(operate(maps.removeByIndex('map', 1).withContext((ctx: cdt.Context) => ctx.addMapValue({ a: 1, b: 2, c: 3 }))))
    ...
    context('with nested map context', function () {
      ...
      it('removes map entries identified by index range', function () {
        return initState()
          ...
          .then(operate(maps.removeByIndexRange('map', 1, 2).withContext((ctx: cdt.Context) => ctx.addMapKey('nested'))))
    ...
    context('with nested map context', function () {
      ...
      it('removes a map entry identified by rank', function () {
        return initState()
          ...
          .then(operate(maps.removeByRank('list', 0).withContext((ctx: cdt.Context) => ctx.addListIndex(0))))
  ...
  describe('maps.removeByRankRange', function () {
    ...
    context('with nested map context', function () {
      ...
      it('removes map entries identified by rank range', function () {
        return initState()
          .then(createRecord({ list: [{ a: 3, b: 2, c: 1 }] }))
          .then(operate(maps.removeByRankRange('list', 0, 2).withContext((ctx: cdt.Context) => ctx.addListIndex(-1))))
  ...
  describe('maps.size', function () {
    ...
    context('with nested map context', function () {
      ...
      it('returns the size of the map', function () {
        return initState()
          .then(createRecord({ map: { nested: { a: 1, b: 2, c: 3 } } }))
          .then(operate(maps.size('map').withContext((ctx: cdt.Context) => ctx.addMapKey('nested'))))
          .then(assertResultEql({ map: 3 }))
          .then(cleanup())
      })
    })
      ...
      it('fetches a map entry identified by key', function () {
        return initState()
          ...
          .then(operate(
            maps
              .getByKey('list', 'b')
              .withContext((ctx: cdt.Context) => ctx.addListIndex(0))
        ...
        return initState()
          ...
          .then(operate(
            maps
              ...
              .withContext((ctx: cdt.Context) => ctx.addListIndex(1))
      ...
      it('fetches a map entry identified by index', function () {
        return initState()
          ...
          .then(operate(
            maps
              .getByIndex('list', 1)
              .withContext((ctx: cdt.Context) => ctx.addListIndex(4))
              .andReturn(maps.returnType.KEY_VALUE)
          ))
          .then(assertResultEql({ list: ['b', 2] }))
          .then(cleanup())
