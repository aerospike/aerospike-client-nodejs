...
import * as valgen from './value.mts';

//
// Returns a generator for bytes keys.
//
export function bytes (namespace: any, set: any, options?: any) {
...
//
export function string (namespace: any, set: any, options?: any) {
...
//
export function integer (namespace: any, set: any, options?: any) {
