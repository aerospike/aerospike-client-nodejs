...
describe('Queries', function () {
  ...
  const indexes: any = [
    ...
    ['qidxStr', exp.binStr('s'), STRING],
    ['qidxStrList', exp.binList('ls'), STRING, LIST],
    ['qidxStrMap', exp.binMap('ms'), STRING, MAPVALUES],
    ['qidxStrMapKeys', exp.binMap('mks'), STRING, MAPKEYS],
